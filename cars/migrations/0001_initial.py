# Generated by Django 3.0.7 on 2022-01-24 05:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo1', models.ImageField(blank=True, upload_to='carsimage/%Y/%m/%d')),
                ('car_photo2', models.ImageField(blank=True, upload_to='carsimage/%Y/%m/%d')),
                ('car_photo3', models.ImageField(blank=True, upload_to='carsimage/%Y/%m/%d')),
                ('car_photo4', models.ImageField(blank=True, upload_to='carsimage/%Y/%m/%d')),
                ...
                ('created_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 1, 24, 9, 34, 28, 491973))),
            ],
        ),
    ]
