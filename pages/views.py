...
def homeView(request):
    ...
    model_search = Car.objects.values_list('model',flat=True)
    city_search = Car.objects.values_list('city',flat=True)
    year_search = Car.objects.values_list('year',flat=True)
    body_style_search = Car.objects.values_list('body_style',flat=True)
